...
const EditProfileForm: FC<EditProfileFormProps> = ({ onEditProfile }) => {
  return (
    <div className="fixed top-0 left-0 h-screen w-screen bg-black bg-opacity-40 z-25 no-doc-scroll">
      <section className="fixed top-0 left-0 w-screen h-screen flex justify-center items-center">
        <div className="relative h-[620px] w-[570px] bg-white rounded-[20px] p-10">
          ...
          <div>
            <div className=''>
              <label htmlFor="" className="text-[12px] text-[#00000099] block">Name</label>
              <input
                type="text"
            ...
            <div className='flex items-center justify-between mt-4'>
              <div>
                <label htmlFor="" className="text-[12px] text-[#00000099] block">City</label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="" className="text-[12px] text-[#00000099] block">Birthday</label>
                <input
                  type='date'
            ...
            <div className="mt-4">
              <label htmlFor="" className="text-[12px] text-[#00000099] block">Gender</label>
            ...
            <div className='mt-4'>
              <label htmlFor="" className="text-[12px] text-[#00000099] block">Address</label>
              <input
                type="text"
                className="border-b border-[#0000006B] w-full focus:outline-none"
            ...
            <div className='mt-4'>
              <label htmlFor="" className="text-[12px] text-[#00000099] block">Phone Number</label>
              <input
                type="text"
                className="border-b border-[#0000006B] w-full focus:outline-none"
            ...
            <div className='mt-4'>
              <label htmlFor="" className="text-[12px] text-[#00000099] block">NIK</label>
              <input
                type="number"
                className="border-b border-[#0000006B] w-full focus:outline-none"
