    ...
    <section className='bg-[#F2F5F9] space-y-8 pb-10'>
      <div className='max-w-[1100px] mx-auto pt-5 flex justify-between items-center gap-4'>
        ...
        <div className='h-[402px] w-[740px] bg-white rounded-[12px] pt-10 px-14 flex gap-4 justify-between'>
          ...
          <div>
            <button className='hover:bg-slate-50 transition-all h-[40px] w-[130px] border border-black text-[16px]'>Edit Profile</button>
          </div>
        </div>
      </div>
      ...
      <div className='max-w-[1100px] mx-auto bg-white rounded-[12px] pt-8 pb-16 px-12 space-y-8'>
        <div className='rounded-[12px] bg-[#F2F5F9] h-[60px] w-[330px] flex justify-between items-center p-4'>
          <button className='h-[44px] w-[110px] bg-white rounded-[12px] text-[16px]'>Last Patient</button>
          <button className='h-[44px]'>Upcoming appointments</button>
        </div>
          ...
          <div className='py-6 px-8 space-y-8'>
            {[1, 2, 3].map(item => (
              <div
                ...
                <div>
                  <button className='h-[40px] w-[130px] border border-black hover:bg-slate-50 transition-all'>Visit</button>
                </div>
              </div>
            ))}
          </div>
